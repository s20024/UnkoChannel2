...
router.get("/:categoryId/:threadId/:option", homeController.thread, homeController.redirectView)
router.get("/:categoryId/:threadId", homeController.threadNoOption, homeController.redirectView)
